...
- 📱 **Native mobile apps** - Android apps in Kotlin and cross-platform apps in Flutter
- 🎵 **Music artist** - producer, singer, and songwriter performing as **dj M.a.S.e** on all major platforms
- 🏠 Big into Home Theater, Home Automation, and making devices talk to each other
...
A full-stack e-commerce platform for custom tube amplifier building. Customers browse, customize components, and order handcrafted amplifiers - all from a single app.

**Stack:** Flutter/Dart • Supabase (PostgreSQL) • Square & PayPal Payments • Cloudflare CDN • GitHub Actions CI/CD

**Platforms:** [Web](https://elanaudiolab.com) • iOS • Android (Google Play)

**Highlights:**
- Real-time product customization with shareable configurations
- Secure checkout (Square + PayPal native SDKs)
- Admin portal with order management, warranty tracking, and analytics
- Automated email system (14 branded templates)
- A-grade security (RLS policies, rate limiting, PII protection)

---

### 🎮 Unfolded Circle Integration Ecosystem

**42+ integrations** connecting devices across AV, streaming, gaming, smart home, and more to the Unfolded Circle Remote 2/3. Over **7,300+ downloads** and **210+ stars** across the ecosystem.
...
| :--- | :--- | :--- |
| **[uc-remote-android](https://github.com/mase1981/uc-remote-android)** | Android | Unofficial Android companion app for the Unfolded Circle Remote |
| **[barcode-scanner](https://github.com/mase1981/barcode-scanner)** | Android (Kotlin) | Barcode scanning utility app |
| **[Elan Audio Lab](https://elanaudiolab.com)** | Web, iOS, Android | Cross-platform e-commerce app (Flutter) |
...
| **[uc-intg-list](https://github.com/mase1981/uc-intg-list)** | Directory of all UC integrations |
...
**Also:** Supabase • Square SDK • PayPal SDK • Cloudflare • Firebase • GitHub Actions CI/CD

---

## 🎶 Music

I'm also a music artist performing under the stage name **dj M.a.S.e** - producer, singer, and songwriter. You can find my original music on all major platforms:
...
<p align="left">
  ...
  <a href="https://open.spotify.com/artist/6xZVRkgbFVH6LmVFMESGJy?si=ayaiMd5rSJqnfODfnvRIeA" target="_blank">
...
If you enjoy my projects and want to support future development, any support is greatly appreciated!

[![GitHub Sponsors](https://img.shields.io/badge/GitHub%20Sponsors-30363D?style=for-the-badge&logo=GitHub-Sponsors&logoColor=EA4AAA)](https://github.com/sponsors/mase1981)
[![Buy Me A Coffee](https://img.shields.io/badge/Buy_Me_A_Coffee-FFDD00?style=for-the-badge&logo=buy-me-a-coffee&logoColor=black)](https://buymeacoffee.com/meirmiyara)
...
<p align="left">
  <a href="https://www.linkedin.com/in/meirmiyara/" target="_blank">
    <img src="https://img.shields.io/badge/LinkedIn-0077B5?style=for-the-badge&logo=linkedin&logoColor=white" alt="LinkedIn"/>
  </a>
  <a href="https://elanaudiolab.com/contact" target="_blank">
    <img src="https://img.shields.io/badge/Elan_Audio_Lab-FF6B35?style=for-the-badge&logo=amp&logoColor=white" alt="Elan Audio Lab"/>
  </a>
</p>
